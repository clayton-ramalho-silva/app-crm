...
<div class="row invoice layout-spacing layout-top-spacing" style="margin-top: 150px">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        @csrf
            <select name="customer" class="form-control  basic">
            ...
            <select name="products[]" class="form-control basic tagging" multiple="multiple">

                <option selected>Escolher Produto</option>
            ...
            <div class="form-group">
                <label for=""> Obs.:</label>
                <textarea class="form-control" name="obs" cols="30" rows="10"></textarea>
            </div>
