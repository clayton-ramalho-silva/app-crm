                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="description">
                                                        <input name="name" type="text" class="form-control form-control-sm" placeholder="Título do produto" value="{{ $product->name }}">
                                                        <textarea name="description" rows="10" class="form-control" placeholder="Descrição do produto">{{ $product->description }}</textarea>
                                                    </td>
                                                    <td class="rate">
                                                        <input name="price" type="text" class="form-control form-control-sm" placeholder="Valor" value="{{ $product->price }}">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
