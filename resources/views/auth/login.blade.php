        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <h1 class="">Sign In</h1>
                    <p class="">Entre com uma conta para continuar.</p>
                    ...
                    <form class="text-left" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="username" name="email" type="text" class="form-control" placeholder="example@email.com" value="{{ old('email') }}">
                            </div>

                            <div id="password-field" class="field-wrapper input mb-2">
                                <div class="d-flex justify-content-between">
                                    <label for="password">PASSWORD</label>
                                    <a href="auth_pass_recovery_boxed.html" class="forgot-pass-link">Esqueci minha senha!</a>
                                </div>
